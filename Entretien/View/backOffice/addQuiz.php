...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['title'], $_POST['description'], $_POST['author']) &&
        !empty($_POST['title']) &&
        ...
        header('Location:listQuiz.php'); // Redirect to another page after success
    } else {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container mt-5">
                        ...
                        <?php endif; ?>
                        <form id="quizForm" action="addQuiz.php" method="POST" class="form"> 
