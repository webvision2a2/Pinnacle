...
$quizzes = $userQuizController->listQuizzes(); // Fetch all user_quizzes 
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="text-center text-primary">Liste des Quizzes-Utilisateur</h1>
                                ...
                                <?php if (!empty($quizzes)): ?>
                                    <?php foreach ($quizzes as $quiz): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($quiz['user_id']) ?></td>
                                            <td><?= htmlspecialchars($quiz['score']) ?></td>
                                            <td><?= htmlspecialchars($quiz['attempts']) ?></td>
                                            <td><?= htmlspecialchars($quiz['email']) ?></td>
                                            <td>
                                                <a href="updateUserQuiz.php?id=<?= $quiz['id'] ?>" class="btn btn-sm btn-warning">Modifier</a>
                                                <a href="deleteUserQuiz.php?id=<?= $quiz['id'] ?>" class="btn btn-sm btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center">Aucun userQuiz trouvé</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
