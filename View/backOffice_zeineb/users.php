    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center">
            <div class="sidebar-brand-icon">
                <img class="logo" src="../frontOffice_zeineb/Template/img/LOGO white.png" alt="Pinnacle Logo" style="max-width: 30px;">
            </div>
        ...
        <main class="container mt-5">
            ...
            <form action="" method="GET" >
                <div class="input-group"">
                    <input type="text" name="keyword" placeholder="Recherche de ..." class="form-control search" aria-label="Search" aria-describedby="basic-addon2" 
            ...
            <div class="header-section d-flex justify-content-between align-items-center">
                <form method="GET" action="" class="filter-form">
                    ...
                    <select name="sort_order" id="sort_order">
                        <option value="desc" <?php if (isset($_GET['sort_order']) && $_GET['sort_order'] == 'desc') echo 'selected'; ?>>Les plus récents</option>
                        <option value="asc" <?php if (isset($_GET['sort_order']) && $_GET['sort_order'] == 'asc') echo 'selected'; ?>>Les plus anciens</option>
                    </select>
                    ...
                    <select name="role_filter" id="role_filter">
                        ...
                        <option value="1" <?php if (isset($_GET['role_filter']) && $_GET['role_filter'] == '1') echo 'selected'; ?>>Administrateur</option>
                        <option value="2" <?php if (isset($_GET['role_filter']) && $_GET['role_filter'] == '2') echo 'selected'; ?>>Client</option>
                    </select>
                        ...
                        <tbody>
                                <?php foreach ($users_to_display as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="deleteUser.php?id=<?= htmlspecialchars($user['id']); ?>" class="btn btn-danger btn-sm">Supprimer</a>
                                        </td>
                                        <td>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <?php if ($current_page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?= $current_page - 1; ?>&keyword=<?= htmlspecialchars($keyword); ?>&sort_order=<?= $sort_order; ?>&role_filter=<?= $role_filter; ?>" aria-label="Previous">
                            ...
                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                <li class="page-item <?= $i == $current_page ? 'active' : ''; ?>">
                                    <a class="page-link" href="?page=<?= $i; ?>&keyword=<?= htmlspecialchars($keyword); ?>&sort_order=<?= $sort_order; ?>&role_filter=<?= $role_filter; ?>"><?= $i; ?></a>
                                </li>
                            <?php endfor; ?>
                            <?php if ($current_page < $total_pages): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?= $current_page + 1; ?>&keyword=<?= htmlspecialchars($keyword); ?>&sort_order=<?= $sort_order; ?>&role_filter=<?= $role_filter; ?>" aria-label="Next">
