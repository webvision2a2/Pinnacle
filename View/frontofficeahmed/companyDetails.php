        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="../frontOffice_zeineb/Template/index.php" class="nav-item nav-link">Accueil</a>
                    <a href="../frontoff/catalogue.html" class="nav-item nav-link">Catalogue</a>
                    <a href="contact.html" class="nav-item nav-link">Entretien</a>
                    <a href="main.php" class="nav-item nav-link active">Societes</a>
                    <a href="main2.php" class="nav-item nav-link ">Stages</a>
                    <a href="../frontOffice_zeineb/Template/profile.php" class="nav-item nav-link">Profil</a>
                </div>
