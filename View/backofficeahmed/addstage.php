<<<<<<< HEAD
=======
<<<<<<< HEAD:View/backofficeahmed/addstage.php
=======
<<<<<<< HEAD
=======
<<<<<<< HEAD
...
if (isset($_POST["submit"])) {
    if (empty($_POST["type"]) || empty($_POST["duration"]) || empty($_POST["email"]) || empty($_POST["id_societe"])) {
...
>>>>>>> b4a7ddee5f45959b2e0369349cbe89e271e53df7:View/backoffice/addstage.php
