...
<div class="container-xxl bg-white p-0">
       ...
       <!--  <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <div class="container-xxl bg-primary hero-header">
            <div class="container px-lg-5">
                <div class="container py-5">
                    <div class="main-body">
        <div class="wrapper" style="max-width: 400px; margin: 0px auto; background: #f8f9fa; padding: 20px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
        <h2 class="text-center">Réinitialiser le mot de passe</h2>
        <p class="text-center text-muted">Veuillez remplir ce formulaire pour réinitialiser votre mot de passe.</p>
        <form id="resetPasswordForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <button id="submit" type="submit" class="btn btn-primary btn-block w-100 rounded-pill">Réinitialiser</button>
