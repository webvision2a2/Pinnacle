...
<body>
    ...
    <di class="container-xxl bg-white p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mx-auto py-0">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Evenement </a>
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="../frontoff/catalogue.php" class="nav-item nav-link" style="color: white;">Catalogue</a>
            ...
            <div class="events-container">
                ...
                <?php foreach ($events as $event): ?>
                    <div class="event-card" data-event-id="<?= htmlspecialchars($event['id']) ?>"
                        data-category="<?= htmlspecialchars($event['categories']) ?>"
                        data-participants="<?= htmlspecialchars($event['participants']) ?>">
                        <div class="event-title" style="color: #333;"><?= htmlspecialchars($event['title']) ?></div>
                        <img src="../BackOffice/uploads/<?= htmlspecialchars($event['image'] ?? 'default.jpg') ?>"
                            alt="Event Image">
                        ...
                        <div class="event-actions">
                            <button type="button" onclick="showEventDetails(<?= htmlspecialchars(json_encode($event)) ?>)"
                                class="event-button1"><span>Détails</span><span></span></button>
                            <button type="button" class="event-button" data-event-id="<?= htmlspecialchars($event['id']) ?>"
                                onclick="showParticipationModal('<?= htmlspecialchars($event['title']) ?>', <?= htmlspecialchars($event['id']) ?>)">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="event-button" id="confirmParticipationButton"
    ...
    <h3 style="text-align: center; color:blue;">Pour vous inscrire en personne, nous serons ravis de vous accueillir à
        notre adresse :</h3>
    <div class="map-container">
        <div id="map"></div><br>
        <div style="display: flex; justify-content: center; text-align: center;">
            <a href="https://www.google.com/maps?q=36.8506,10.2107&hl=en" target="_blank" class="event-button3"
    ...
    <div style="display: flex; justify-content: center; text-align: center;">
        <a href="mailto:pinnacleofficiel@gmail.com" class="event-button3"
            style="display: inline-flex; align-items: center; text-decoration: none; color: inherit; border: 1px solid #ccc; padding: 10px 20px; border-radius: 5px;">
        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-3">
                ...
                <div class="d-flex pt-2">
                    ...
                    <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/kallagui/"><i
                            class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/dhiaallagui.pdf/"><i
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-4">
                        <img class="img-fluid"
                            src="img/Skills-needed-to-be-a-good-game-developer-University-of-Bolton.webp" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="img/media_124631e4062698c444e9a7724c90a6b5f3531d6d6.png"
                            alt="Image">
                    </div>
                    <div class="col-4">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    Designed By <a class="border-bottom" href="https://www.instagram.com/dhiaallagui.pdf/">Dhia
                        allagui</a>
                </div>
