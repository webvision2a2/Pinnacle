...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        isset($_POST['content'], $_POST['points'], $_POST['type']) &&
        !empty($_POST['content']) &&
        !empty($_POST['points']) &&
        !empty($_POST['type']) &&
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="container mt-5">
                        ...
                        <!-- Form -->
                        <form id="questionForm" action="addQuestion.php?id_quiz=<?= htmlspecialchars($id_quiz) ?>"
                            ...
                            <a href="listQuestion.php?id_quiz=<?= htmlspecialchars($id_quiz) ?>"
