...
<head>
    ...
    <!-- Favicon -->
    <link href="img/LOGO 1 blue.png" rel="icon">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="service.html" class="nav-item nav-link">Psychologie</a>
                        <a href="project.html" class="nav-item nav-link">Entretien</a>
                        <a href="project.html" class="nav-item nav-link">Reseau</a>
