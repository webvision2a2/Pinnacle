        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Domaines</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $statsData['totalDomaines']; ?></div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Cours</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $statsData['totalCours']; ?></div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Domaine le Plus Actif</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Dernier Domaine Ajouté</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
...
<!-- End Statistics Cards -->
    ...
    <form method='POST' enctype='multipart/form-data' onsubmit='return validateForm()' class='mb-4'>
        ...
        <div class='form-group'>
            ...
            <input type='text' name='nom' id='nom' placeholder='Entrez le nom du domaine' class='form-control' value="<?php echo isset($domaineToEdit) ? htmlspecialchars($domaineToEdit['nom']) : ''; ?>">
        ...
        <tbody>
            <?php foreach ($domaines as $domaine): ?>
                <tr>
                    ...
                    <td><img src="<?php echo htmlspecialchars($domaine['image']); ?>" alt="<?php echo htmlspecialchars($domaine['nom']); ?>" style='width: 100px;'></td>
                    <td>
                                          <td>
                        <a href="?edit=<?php echo htmlspecialchars($domaine['id']); ?>" class="btn btn-warning btn-sm">Modifier</a> 
                        <a href="?delete=<?php echo htmlspecialchars($domaine['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce domaine ?');">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <form method='POST' enctype='multipart/form-data' onsubmit="return validateCourseForm();" class='mb-4'>
        ...
        <div class='form-group'>
            ...
            <select name='domaine_id' id='domaine_id' class='form-control'>
                ...
                <?php foreach ($domaines as $domaine): ?>
                    <option value='<?php echo htmlspecialchars($domaine['id']); ?>'><?php echo htmlspecialchars($domaine['nom']); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class='form-group'>
            ...
            <input type='text' name='nomCours' id='nomCours' placeholder='Entrez le nom du cours' class='form-control' value="<?php echo isset($courseToEdit) ? htmlspecialchars($courseToEdit['nom']) : ''; ?>" />
            <div id='coursenomError' class='error-message'></div>
        </div>

        <div class='form-group'>
            <label for='fichier'>Fichier:</label>
            <input type='file' name='fichier' id='fichier' accept='.pdf,.doc,.docx' class='form-control' />
        ...
        <tbody>
            <?php foreach ($cours as $course): ?>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($domaine['nom']); ?></td>
                    <td>
                        <a href="?editcours=<?php echo htmlspecialchars($course['id_cours']); ?>" class="btn btn-warning btn-sm">Modifier</a> 
                        <a href="?deletecours=<?php echo htmlspecialchars($course['id_cours']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce cours ?');">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
