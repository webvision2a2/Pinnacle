...
include_once 'C:\xampp\htdocs\validation 2\config.php'; // Correct path to config.php

function addCours($nom, $fichier, $domaine_id) {
    $database = new Database(); // Use correct class name
    $db = $database->connect(); // Get connection
